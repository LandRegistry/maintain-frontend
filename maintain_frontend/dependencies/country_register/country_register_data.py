# This list was acquired by using the countries register api at https://www.registers.service.gov.uk/registers/country
# List was created on 08/08/18 - please update list and creation date as required
