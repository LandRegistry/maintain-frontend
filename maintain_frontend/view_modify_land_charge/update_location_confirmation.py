...
def register_routes(bp):
    bp.add_url_rule('/update-location-confirmation',
                    view_func=get_update_location_confirmation,
                    methods=['GET'])
    bp.add_url_rule('/update-location-confirmation',
                    view_func=post_update_location_confirmation,
                    methods=['POST'])
...
def get_update_location_confirmation():
    ...
    current_app.logger.info("Displaying page 'update_location_confirmation.html'")

    return render_template('update_location_confirmation.html',
                           submit_url=url_for('modify_land_charge.post_update_location_confirmation'),
...
def post_update_location_confirmation():
    ...
    validation_errors = LocationConfirmationValidator.validate(confirmation, 'update')
